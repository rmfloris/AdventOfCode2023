...
class Day9Part2 {
    ...
    public function __construct($filename) {
        ...
        $this->currentLocations = array_fill(0,2,["x"=>0, "y"=>0]);
    }
    ...
    private function makeMoveHead($direction, $steps) {
        for($i=0; $i<$steps;$i++) {
            // echo "Start=> x: ". $this->currentLocations[0]["x"] ." - y: ". $this->currentLocations[0]["y"] ."<br>";
            ...
            // echo "After step=> x: ". $this->currentLocations[0]["x"] ." - y: ". $this->currentLocations[0]["y"] ."<br>";
        }
    }
    ...
    private function checkNextKnotTouching ($prevKnotIndex) {
        ...
        // echo "Prev: ". print_r($this->currentLocations[$prevKnotIndex], true) ."<br>";
        // echo "curr: ". print_r($this->currentLocations[$currentKnotIndex], true) ."<br>";
        ...
        // echo "current: ". $currentKnotIndex ." - d: ". $direction ." - pos: ". print_r($this->currentLocations[$currentKnotIndex], true) ."<br>";
        [$x, $y] = $this->calculateStep($direction);
